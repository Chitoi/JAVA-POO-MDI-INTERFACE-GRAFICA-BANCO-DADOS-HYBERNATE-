...
public class JFrameTime extends javax.swing.JFrame {
    ...
    private void BtnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCadastrarActionPerformed
        int v=(int)SpnVitorias.getValue();
        int e=(int)SpnEmpates.getValue();
        int d=(int)SpnDerrotas.getValue();
        
        boolean temNome= !TxtNome.getText().isEmpty() && TxtNome.getText().trim().length()>0;
        boolean jogou = v>0 || e>0 || d>0;
        
        
        if(cont < t.length && jogou &&temNome){
           t[cont] =new Time();
           t[cont].cadastrar(
                   TxtNome.getText(), 
          ...
          cont++;
            ...
            JOptionPane.showMessageDialog(JFrameTime.this, "Para cadastra um time"
                                                            +"tem que ter no minimo 1 jogo : ");
        }else{
    ...
    private void BtnMelhorAproveitamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMelhorAproveitamentoActionPerformed
        ...
        if(cont>0){
            String r = Time.BtnMelhorAproveitamentoActionPerformed(t);
            JOptionPane.showMessageDialog(JFrameTime.this, r);
        }
        else{
            JOptionPane.showMessageDialog(JFrameTime.this, "Não time ");
    }
